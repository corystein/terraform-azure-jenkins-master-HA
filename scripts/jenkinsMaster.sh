...
restart_jenkins
echo "Completed enabling Jenkins CLI"
#######################################
...
#sed -i 's/true/false/g' /var/lib/jenkins/jenkins.CLI.xml /var/lib/jenkins/jenkins.CLI.xml
#restart_jenkins
#echo "Completed disabling Jenkins CLI"
#######################################
